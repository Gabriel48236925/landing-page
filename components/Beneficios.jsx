export default function Beneficios() { return ( <section className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8 py-20 bg-zincOverlay backdrop-blur-md rounded-2xl border border-zinc-700 text-white shadow-md"> <h2 className="text-2xl md:text-3xl font-semibold mb-12 text-primary text-center" data-aos="fade-up" > O que você recebe no plano inicial (R$ 297) </h2>
