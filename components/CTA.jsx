import { useState } from "react"; import { Dialog } from "@headlessui/react"; import { X } from "lucide-react";

export default function CTA() { const [isOpen, setIsOpen] = useState(false); const [form, setForm] = useState({ nome: "", negocio: "", objetivo: "", publico: "", cores: "", contato: "", secoes: "", });

const handleChange = (e) => { setForm({ ...form, [e.target.name]: e.target.value }); };

const handleSubmit = (e) => { e.preventDefault(); alert("Formulário enviado com sucesso!\n\n" + JSON.stringify(form, null, 2)); setIsOpen(false); };

return ( <section id="cta" className="py-20 px-4 sm:px-6 bg-zincOverlay backdrop-blur-md border border-zinc-700 rounded-2xl max-w-4xl mx-auto text-center shadow-lg" > <h2 className="text-3xl md:text-4xl font-bold mb-6 text-primary" data-aos="fade-up" > Pronto para tirar seu projeto do papel? </h2>
